    ...
    try:
        ...
        with open(sfile, 'a',encoding='utf-8',newline='') as csvfile:
            ...
            while True:
                ...
                webbrowser.get('firefox').open_new_tab(url="https://www.justdial.com/%s/nct-10296083/page-%s" % (district,page_number))
                time.sleep(20)
                pyautogui.hotkey('ctrl', 's')
                time.sleep(2)
                #pyautogui.typewrite('temp{}'.format(page_number))s
                #time.sleep(2)
                pyautogui.press('enter')
                time.sleep(8)
                pyautogui.click(1273,10)
                extension = 'htm'
